...
if (!class_exists('\\WPAICG\\WPAICG_OpenAI')) {
    class WPAICG_OpenAI
    {
        ...
        public function openai()
        {
            ...
            if ($wpaicg_settings && isset($user_openai_api_key) && !empty($user_openai_api_key)) {
                add_action('http_api_curl', array($this, 'filterCurlForStream'));
                $this->headers = [
                    'Content-Type' => 'application/json',
                    'Authorization' => 'Bearer ' . $user_openai_api_key,
                ];
                ...
                $wpaicg_settings['api_key'] = $user_openai_api_key;
