        ...
        <tr>
            <td>
                ...
                <form action="" method="POST">
                    ...
                    <button class="button button-primary" onclick="if (confirm('<?php fs_esc_attr_echo_inline('Are you sure you want to delete all Freemius data?', 'delete-all-confirm') ?>')) this.parentNode.submit(); return false;"><?php fs_esc_html_echo_inline('Delete All Accounts') ?></button>
                </form>
            </td>
            <td>
                <!-- Clear API Cache -->
                        ...
                        <td<?php if ($is_active && true !== $has_api_connectivity) {
                                ...
                                echo esc_html(
                                    true === $has_api_connectivity ?
                                        fs_text_x_inline('Connected', 'as connection was successful') : (false === $has_api_connectivity ?
    ...
    <div id="fs_debug_filters">
        ...
        <div style="margin: 10px 0">
            ...
            <form action="" method="POST" style="float: left; margin-left: 10px;">
                ...
                <button id="fs_download" class="button" type="submit"><i class="dashicons dashicons-download"></i> <?php fs_esc_html_echo_inline('Download') ?></button>
            </form>
