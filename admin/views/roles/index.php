                            ...
                            ?>
                                ...
                                if (isset($wpaicg_role['hide']) && !empty($wpaicg_role['hide'])) {
                                    ...
                                    <div class="wpaicg-grid-1">
                                        <div class="wpaicg-role-item">
                                            <label>
                                                <input<?php echo in_array('wpaicg_' . $key, $role_modules) ? ' checked' : '' ?> name="wpaicgroles[<?php echo esc_html($role) ?>][]" value="wpaicg_<?php echo esc_html($key) ?>" class="wpaicg_role_<?php echo esc_html($role) ?>" type="checkbox">&nbsp;<?php echo esc_html__($wpaicg_role['name'], 'gpt3-ai-content-generator') ?>
                                            </label>
                                        </div>
                                    </div>
                                <?php
